import { Text, Flex, Switch, Box, Button, Card, Container } from '@radix-ui/themes';
import './App.css';
...
function App() {
  ...
  useEffect(() => {
    ...
    const handleImgOnload = function() {
      ...
      const [dx, dy, dw, dh] = aspectFit(imgWidth, imgHeight, CANVAS_WIDTH, CANVAS_HEIGHT)
        ...
        <Container size="3">
          <Card variant="classic" >
            <div className="line">
              ...
              <input accept="image/*" id="fileInput" type="file" onChange={(e) => {
            ...
            <div className="line">
              <Text as="label" size="2">
                <Flex gap="2">
                  <Switch defaultChecked={showMask} onClick={(e) => {
            ...
            <div className="line">
              <Flex justify="between">
                ...
                <Flex gap="2">
                  ...
                  <input id="retire-input" type="text" onChange={(e) => setRetireId(e.target.value)} value={retireId} />
                  <Button type="button" onClick={retireFromDb}>Retire</Button>
                </Flex>
              </Flex>
            </div>
            <div className="line">
            ...
            <div className="preview-canvas line" style={{
